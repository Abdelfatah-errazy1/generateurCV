...
use App\Models\Qualite as ModelTarget;
...
class QualitesController extends Controller
{
    ...
    {
        $actions = [
            new Action(ucwords(trans('words.add')), Action::TYPE_NORMAL, url: route('qualites.create',$profil)),
    ...
    {
        return view('crud.qualites.create',compact('profil'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('crud.qualites.edit', [
            'model' => $model
        ]);
    }
     ...
     */
    public function store(addQualite $request)
    {
