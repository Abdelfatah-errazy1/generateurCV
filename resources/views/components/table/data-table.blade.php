<div class="card">
                ...
                <li class="nav-item ms-auto">
                    ...
                    <div
                        ...
                        <div class="menu-item px-5">
                            <div
                                class="menu-content text-muted pb-2 px-5 fs-7 text-uppercase">  {{ ucwords(trans('words.actions')) }}</div>
                        </div>
    ...
    <div class="card-body py-4">
        <div class="table-responsive">
            <table @if(isset($identifier)) mrx-dt-id="{{ $identifier }}"
                            ...
                            <td>
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input {{ $generateTbodyInputCheckboxClass() }}"
                                           type="checkbox" value="{{ \Crypt::encrypt($model[$model::PK]) }}"/>
                                </div>
                            </td>
                                        ...
                                        @if(isset($editRoute) && !empty($editRoute))
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ $route($model,$editRoute) }}"
                                                   class="menu-link px-3">  {{ ucwords(trans('words.edit')) }}</a>
                                            </div>
                                        @endif
                                        @if(isset($deleteRoute) && !empty($deleteRoute))
                                            <div class="menu-item px-3 ">
                                                <a href="{{ $route($model,$deleteRoute) }}"
                                                   class="menu-link px-3 text-danger delete-record">  {{ ucwords(trans('words.delete')) }}</a>
                                            </div>
                                        @endif
                                    @endif
